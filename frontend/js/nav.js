      ...
      if (response.length > 2) {
        ...
        for (var x in json) {
          ...
          if (rid === 1) {
            ...
            dItem1Link.setAttribute(
              "href",
              "/WebEnProjekt/frontend/sites/editProducts.php"
            );
            ...
            dItem2Link.setAttribute(
              "href",
              "/WebEnProjekt/frontend/sites/newProduct.php"
            );
            ...
            //dropdown menu list item userlist
            var dItem3 = document.createElement("li");

            var dItem3Link = document.createElement("a");
            dItem3Link.classList.add("dropdown-item");
            dItem3Link.setAttribute(
              "href",
              "/WebEnProjekt/frontend/sites/userlist.php"
            );
            dItem3Link.innerHTML =
              "<i class='fa-solid fa-list mx-2'></i>View Users</a>";
            dItem3.appendChild(dItem3Link);
            dropdownMenu.appendChild(dItem3);
          ...
          if (rid === 2) {
            ...
            cartLink.setAttribute(
              "href",
              "/WebEnProjekt/frontend/sites/cart.php"
            );
            cartLink.innerHTML =
            ...
            logoutLink.setAttribute(
              "href",
              "/WebEnProjekt/backend/logic/login.php?logout=true"
            );
