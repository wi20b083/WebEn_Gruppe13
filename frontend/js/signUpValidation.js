...
//checking if value contains only letters
...
//checking if value is between a min and a max value
const isBetween = (length, min, max) =>
  length < min || length > max ? false : true;

//displaying errors by the fields
      ...
      success: function (response) {
        ...
        if (x.status_code == 200) {
          window.location.href =
            "http://localhost/WebEnProjekt/frontend/sites/login.php";
        }
      },
...
//delaying the validation by 500 ms on input
