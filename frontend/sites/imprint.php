...
<head>
    ...
    <title>Imprint Clothing-Gs</title>
...
<div id= "ImprintDiv1" class ="container border border-dark rounded text-center mt-5 pt-5 mb-5 " >
    ...
    <div id = "aboutUs">
        ...
        <div id = "ImprintAboutUs" class ="pt-2">  Our <strong>MISSION</strong> is to let your own style run wild. <br> Besides creative designs and comfortable clothing, we want everyone to find their own style with us!  </div>
        <div id = "ImprintAboutUsInfo" class ="pt-4 pb-5" > <strong>Clothing-Gs</strong> was founded in 2022 by the managing director Florian Huber, Akib Kahn und Nils Petsch. <br>  based in Vienna (Austria) </div>
    </div>
